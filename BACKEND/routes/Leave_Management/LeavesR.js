...
router.put('/update/:id', async (req, res) => {
  try {
    const updatedLeaveRequest = await L_Request.findByIdAndUpdate(req.params.id, req.body, { new: true });
...
router.delete('/delete/:id', async (req, res) => {
  try {
    const deletedLeaveRequest = await L_Request.findByIdAndDelete(req.params.id);
